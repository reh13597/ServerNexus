...
<div class="px-5 pb-10" style="min-height: calc(100vh - 200px);">
    <h1 class="lg:text-6xl md:text-5xl sm:text-4xl text-4xl font-bold md:mt-30 mt-25 select-none">Welcome, <span class="text-primary">{$username}</span></h1>
    <p class="mt-10 text-xl text-stone-400">Explore everything Server Nexus has to offer.</p>
    <p class="mt-10 text-md text-stone-400"><span class="text-primary">Note:</span> <br>Currently, only Java edition servers are supported. Bedrock edition support is coming soon!</p>
    <div class="flex flex-wrap justify-center gap-10 md:mt-20 mt-10">
