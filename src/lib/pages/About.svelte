<div class="px-10 max-w-2xl mx-auto pb-12 select-none">
    ...
    <div class="flex flex-col gap-4 mt-10 lg:text-lg md:text-md text-sm text-left">
        ...
        <p class="mt-3">Have fun and enjoy!</p>
        <p class="mt-3"><span class="text-primary">Note:</span> <br>This website is still a work in progress, but there is more to come!</p>
    </div>
</div>
